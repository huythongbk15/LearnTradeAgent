...
if TYPE_CHECKING:
    from trading_agent.agents.swarm.coordinator import CoordinatorAgent
...
class AgentRegistry:
    ...
    def list_agents(self) -> list[dict]:
        ...
        for name, instance in self._agents.items():
            avg_latency = (
                instance.total_latency / instance.call_count
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            "by_role": {
                role.value: len(names) for role, names in self._role_index.items()
            },
            "total_calls": total_calls,
            "total_errors": total_errors,
            "error_rate": total_errors / total_calls if total_calls > 0 else 0,
            "avg_latency_ms": (total_latency / total_calls * 1000)
            if total_calls > 0
            else 0,
        }
...
class SwarmFactory:
    ...
    def create_minimal_swarm(
        ...
        from trading_agent.agents.swarm.coordinator import CoordinatorAgent, SwarmConfig
