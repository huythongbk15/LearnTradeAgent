...
from trading_agent.strategies.versioning.registry import StrategyVersion, StrategyRegistry
...
class GitVersionStore:
    ...
    def load_version(self, name: str, version: str) -> Optional[StrategyVersion]:
        ...
        from trading_agent.strategies.versioning.registry import StrategyMetadata, RiskProfile, AssetClass
