...
class GitVersionStore:
    ...
    def load_version(self, name: str, version: str) -> Optional[StrategyVersion]:
        ...
        version_obj = StrategyVersion(
            ...
            deployed_at=datetime.fromisoformat(meta_data["deployed_at"])
            if meta_data["deployed_at"]
            else None,
            retired_at=datetime.fromisoformat(meta_data["retired_at"])
            if meta_data["retired_at"]
            else None,
